...
function ViewAsset() {
    ...
    return (
        <div className={`view-asset ${classes.assets}`}>
            ...
            <MTable columns={[{ id: 'name', label: 'Entity Name' }, { id: 'encode', label: 'Entity Code' }, { id: 'entype', label: 'Entity Type' }]} datas={[{ 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }, { 'name': 'smartrepo', 'encode': 'smrt1', 'entype': 'app' }]} edit={handleClickOpen1} add={addAssest} />
            <Dialog
